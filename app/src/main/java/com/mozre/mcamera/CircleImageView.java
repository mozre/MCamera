...
public class CircleImageView extends ImageView {
    private static final String TAG = Constants.getTagName(CircleImageView.class.getSimpleName());
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mReady = true;
//        mBitmap = getBitmapFromDrawable(ContextCompat.getDrawable(context, R.drawable.light));
    }
